...
<body>
	<div class="container">
		...
		<div id="busStopInfo">
			...
			if (busStopId == null || busStopId.isEmpty()) {
				busStopId = "8001378"; // 기본값
			}

			try {
				String urlStr = "http://openapitraffic.daejeon.go.kr/api/rest/stationinfo/getStationByStopID" + "?serviceKey="
				+ serviceKey + "&BusStopID=" + busStopId;
			...
			<div class="button-container"
				...
				<div style="text-align: center;">
					<input type="text" id="busStopIdInput" placeholder="정류장ID 입력"
			...
			<div class="info-box">
				<p>
					<span class="info-label">정류장 이름:</span>
					<%=getNodeValue(element, "BUSSTOP_NM")%></p>
				<p>
					<span class="info-label">영문 이름:</span>
					<%=getNodeValue(element, "BUSSTOP_ENG_NM")%></p>
				<p>
					<span class="info-label">도로명:</span>
					<%=getNodeValue(element, "ROAD_NM")%></p>
				<p>
					<span class="info-label">GPS 좌표:</span> 위도
					<%=latitude%>, 경도
					<%=longitude%>
				</p>
				<p>
					<span class="info-label">버스 노선:</span>
				</p>
			...
			String arrivalUrlStr = "http://openapitraffic.daejeon.go.kr/api/rest/arrive/getArrInfoByStopID" + "?serviceKey="
					+ serviceKey + "&BusStopID=" + busStopId;
			...
			<div class="arrival-info">
				...
				<div class="bus-arrival">
					<p>
						<span class="info-label">버스번호:</span>
 ...
 %>
					...
					<p>
						<span class="info-label">정보 제공 시각:</span>
